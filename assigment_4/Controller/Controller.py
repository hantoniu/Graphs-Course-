...
class Controller:
    ...
    def __init__(self, graph):
        self.__graph = graph
        #self.__graph.readFromFile("graph.tx")
    
    def kruskalAlgorithm(self):
        return self.__graph.kruskalAlgorithm()
        
    def Dijkstra(self, start, end):
        return self.__graph.dijkstraBackwards(start, end)
    ...
    def topologicalSorting(self):
        return self.__graph.topologicalSorting()